"""Tests for chiaroscuro.stats (used by the ``fdr`` subcommand) and for
peak-record construction shared across peak-calling modes."""
...
from chiaroscuro.stats import compute_fdr, select_fdr_threshold
...
def test_simple_peak_records_include_summit():
    params = {
        "threshold": 0.5,
        "mode": "simple",
        "max_gap": 0,
